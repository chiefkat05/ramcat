...
float aabb::response(float xVelocity, float yVelocity, aabb &test, float &xNormal, float &yNormal)
{
    ...
    // if (xVelocity > 0.0f)
    // {
    //     xInvEntry = test.min_x - (min_x + max_x);
    //     xInvExit = (test.min_x + test.max_x) - min_x;
    // }
    // else
    // {
    //     xInvEntry = (test.min_x + test.max_x) - min_x;
    //     xInvExit = test.min_x - (min_x + max_x);
    // }
    // if (yVelocity > 0.0f)
    // {
    //     yInvEntry = test.min_y - (min_y + max_y);
    //     yInvExit = (test.min_y + test.max_y) - min_y;
    // }
    // else
    // {
    //     yInvEntry = (test.min_y + test.max_y) - min_y;
    //     yInvExit = test.min_y - (min_y + max_y);
    // }
    // if (xVelocity == 0.0f)
    // {
